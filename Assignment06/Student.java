...
public class Student {
    ...
    protected void update(String name, int ID, int semester, String dept) {
        this.name=name;
        this.ID=ID;
    ...
    protected Student(double creditInThisCourse, double cgpainThisCourse) {
    ...
    protected void print(int k, String[] courseArray){
        ...
        System.out.println("Present Semester  : "+this.semester);
        ...
        for(int m=x;  ; ) {
            System.out.println("=================================================");
            System.out.println("-------Result--------In Semester No. "+k);
    ...
    protected void delete(){
        ...
        this.CGPA=0.0;
        this.previuosSemesterCGPA=0.0;
        this.completedCredit=0.0;
        this.tempCredit=0.0;
        this.tempCGPA=0.0;
    }
}
